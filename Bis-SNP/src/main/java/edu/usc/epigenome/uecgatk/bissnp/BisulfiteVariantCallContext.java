...
public class BisulfiteVariantCallContext {
	...
	private void setSummaryOnVariantContext() {
		...
		summary.cytosinePatternConfirmedSet = new HashSet<String>(10);
		summary.cytosinePatternInRefSet = new HashSet<String>(10);
	...
	private void setSummaryAcrossReadsGroup() {
		...
		summary.cytosinePatternInRefSet = new HashSet<String>();
		if (!BCGLs.isEmpty()) {
	...
	public class summaryAcrossReadsGroup {
		...
		public HashSet<String> cytosinePatternInRefSet;
