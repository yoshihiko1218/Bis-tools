...
import org.broadinstitute.gatk.engine.io.stubs.SAMReaderArgumentTypeDescriptor;
...
public class BisSNP extends CommandLineExecutable {
	...
	private static String BisVersion = "BisSNP-1.0.1";
	...
	public static String getVersionNumber() {
		...
		return headerInfo.containsKey("org.broadinstitute.gatk.engine.version") ? headerInfo.getString("org.broadinstitute.gatk.engine.version") : "<unknown>";
	}
